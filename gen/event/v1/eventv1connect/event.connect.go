...
const (
	...
	EventServiceSubscribeProcedure = "/event.v1.EventService/Subscribe"
)
...
// Subscribe calls event.v1.EventService.Subscribe.
func (c *eventServiceClient) Subscribe(ctx context.Context, req *v1.SubscribeRequest) (*connect.ServerStreamForClient[v1.SubscribeResponse], error) {
...
func NewEventServiceHandler(svc EventServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	eventServiceMethods := v1.File_event_v1_event_proto.Services().ByName("EventService").Methods()
	eventServiceSubscribeHandler := connect.NewServerStreamHandlerSimple(
...
func (UnimplementedEventServiceHandler) Subscribe(context.Context, *v1.SubscribeRequest, *connect.ServerStream[v1.SubscribeResponse]) error {
	return connect.NewError(connect.CodeUnimplemented, errors.New("event.v1.EventService.Subscribe is not implemented"))
}
