...
// Signature represents an Ed25519 cryptographic signature.
// It is shared across all signed service envelopes.
...
func (x *Signature) GetTimestamp() int64 {
	if x != nil {
		return x.Timestamp
	}
	return 0
...
const file_common_v1_common_proto_rawDesc = "" +
	"\n" +
	"\x16common/v1/common.proto\x12\tcommon.v1\x1a\x1bbuf/validate/validate.proto\"\x95\x01\n" +
	"\tSignature\x12%\n" +
	"\talgorithm\x18\x01 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\talgorithm\x12\x1d\n" +
	"\x05value\x18\x02 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\x05value\x12$\n" +
	"\tsigner_id\x18\x03 \x01(\tB\a\xbaH\x04r\x02\x10\x01R\bsignerId\x12\x1c\n" +
	"\ttimestamp\x18\x04 \x01(\x03R\ttimestampB\x85\x01\n" +
	"\rcom.common.v1B\vCommonProtoP\x01Z\"sg-emulator/gen/common/v1;commonv1\xa2\x02\x03CXX\xaa\x02\tCommon.V1\xca\x02\tCommon\\V1\xe2\x02\x15Common\\V1\\GPBMetadata\xea\x02\n" +
...
var file_common_v1_common_proto_goTypes = []any{
	(*Signature)(nil), // 0: common.v1.Signature
}
